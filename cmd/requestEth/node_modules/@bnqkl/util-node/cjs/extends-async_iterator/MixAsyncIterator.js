...
exports.MixAsyncIterator = void 0;
// import { Evt } from "evt";
const index_js_1 = require("../extends-promise/index.js");
const index_js_2 = require("../extends-array/index.js");
const DONE = Promise.resolve({
    step: { value: undefined, done: true },
});
class MixAsyncIterator {
    constructor() {
        Object.defineProperty(this, "_allGenList", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new index_js_2.FastQuene()
        });
    ...
    async _dequeueGen() {
        ...
        const gen = this._freeGen.shift() ||
            ...
            (await this._genWaitter.push(new index_js_1.PromiseOut()).promise);
        this._handleGen(gen);
    }
    _handleGen(gen) {
        ...
        // 如果完成，则回到自由队列
        (0, index_js_1.safePromiseThen)(item, (value) => {
    ...
    _dequeueResult() {
        ...
        const resultPromise = this._resultWaiter.push(new index_js_1.PromiseOut()).promise;
        /// 必要时，让选手出列
        if (
...
exports.MixAsyncIterator = MixAsyncIterator;
