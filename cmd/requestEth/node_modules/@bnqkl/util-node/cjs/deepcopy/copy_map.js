...
function copyBuffer(value) {
    return (0, buffer_js_1.copy)(value);
}
/**
 * copy Date
 *
...
function copyTypedArray(value, type) {
    return global_js_1.$global[type].from(value);
}
/**
 * shallow copy
 *
...
function getFromCopyMap(type) {
    return copyMap.get(type);
}
exports.getFromCopyMap = getFromCopyMap;
