...
exports.QueneEventEmitter = void 0;
const tslib_1 = require("tslib");
const index_js_1 = require("../event-base/index.js");
const index_js_2 = require("../extends-iterator-is/index.js");
/**一个极简的事件管理模块 */
class QueneEventEmitter {
    constructor() {
        // IN_K = K | "*",
    ...
    on(eventname, handler, opts = {}) {
        ...
        if (opts.taskname === undefined) {
            opts.taskname = (0, index_js_1.GetCallerInfo)(this.on);
        }
    ...
    get [index_js_1.EVENT_DESCRIPTION_SYMBOL]() {
        return "";
    }
    /**触发事件监听 */
    emit(eventname, data) {
        ...
        if (handlerMap) {
            if (index_js_1.isDev) {
                if (handlerMap.size) {
                    console.log(...index_js_1.eventDebugStyle.head("%s QUENE EMIT [%s]", index_js_1.eventDebugStyle.DARKVIOLET_BOLD_UNDERLINE), this[index_js_1.EVENT_DESCRIPTION_SYMBOL] || this, eventname, data);
                }
            }
            const iterator = handlerMap.entries();
            const openAg = (res) => {
                if (typeof res === "object") {
                    if ((0, index_js_2.isAsyncGeneratorInstance)(res)) {
                        return (async () => {
                            try {
                    ...
                    else if ((0, index_js_2.isGeneratorInstance)(res)) {
            ...
            const next = () => {
                ...
                if (!item.done) {
                    ...
                    try {
                        if (index_js_1.isDev) {
                            console.log(...index_js_1.eventDebugStyle.head("RUN [%s]", index_js_1.eventDebugStyle.DARKVIOLET_BOLD_UNDERLINE), handler.name);
                        }
    ...
    onError(errorHandler, taskname) {
        if (typeof taskname === "string") {
            (0, index_js_1.renameFunction)(errorHandler, taskname);
        }
...
exports.QueneEventEmitter = QueneEventEmitter;
