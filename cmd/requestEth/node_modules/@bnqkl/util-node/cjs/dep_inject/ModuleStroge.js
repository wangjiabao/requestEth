...
exports.ModuleStroge = exports.MODULE_MAP = void 0;
const tslib_1 = require("tslib");
const Injectable_js_1 = require("./Injectable.js");
const common_js_1 = require("./common.js");
const index_js_1 = require("../extends-map/index.js");
exports.MODULE_MAP = Symbol("module-map");
/**有几层面具 */
...
let ModuleStroge = class ModuleStroge {
    constructor(entries, parent) {
        ...
        this.set(exports.MODULE_MAP, this);
    }
    clear() {
    ...
    groupInsert(groupName, instance) {
        const pluginCollection = this._groupCollection ||
            (this._groupCollection = new index_js_1.EasyMap((name) => new Set()));
    ...
    groupGet(...CtorRootList) {
        ...
        for (const CtorRoot of CtorRootList) {
            ...
            switch (typeof CtorRoot) {
                case "function":
                    groups = [...(0, common_js_1.getInjectionGroups)(CtorRoot)];
                    break;
                case "object":
                    groups = CtorRoot;
                    break;
...
ModuleStroge = tslib_1.__decorate([
    (0, Injectable_js_1.Injectable)(exports.MODULE_MAP),
    tslib_1.__metadata("design:paramtypes", [Object, ModuleStroge])
], ModuleStroge);
exports.ModuleStroge = ModuleStroge;
