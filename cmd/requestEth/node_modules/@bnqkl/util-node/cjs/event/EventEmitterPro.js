...
exports.MapEventEmitterPro = void 0;
const tslib_1 = require("tslib");
const index_js_1 = require("../extends-promise-out/index.js");
const index_js_2 = require("../event-base/index.js");
const index_js_3 = require("../event-map_emitter/index.js");
class MapEventEmitterPro extends index_js_3.MapEventEmitter {
    constructor() {
        super(...arguments);
        ...
        if (this._hasCommonEmitHandlerMap) {
            if (index_js_2.isDev) {
                if (this._commonEmitHandlerMap.size) {
                    console.log(...index_js_2.eventDebugStyle.head("%s EMIT WILDCARDS * [%s]", index_js_2.eventDebugStyle.MIDNIGHTBLUE_BOLD_UNDERLINE), this[index_js_2.EVENT_DESCRIPTION_SYMBOL] || this, { eventname, args });
                }
            }
            for (const [commonHanlder, opts] of this._commonEmitHandlerMap) {
                try {
                    if (index_js_2.isDev) {
                        ...
                        console.log(...index_js_2.eventDebugStyle.head("RUN [%s]", index_js_2.eventDebugStyle.MIDNIGHTBLUE_BOLD_UNDERLINE), taskname);
                    }
    ...
    onEmit(commonHanlder, opts = {}) {
        ...
        if (opts.taskname === undefined) {
            opts.taskname = (0, index_js_2.GetCallerInfo)(this.onEmit);
        }
    ...
    after(eventname) {
        ...
        if (!task) {
            task = this._afterTasks[eventname] = new index_js_1.PromiseOut();
        }
        return task.promise;
    }
    /**
    ...
    before(eventname) {
        ...
        if (!task) {
            task = this._beforeTasks[eventname] = new index_js_1.PromiseOut();
        }
        return task.promise;
    }
    /**
...
exports.MapEventEmitterPro = MapEventEmitterPro;
