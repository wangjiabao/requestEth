...
exports.safePromiseOffThen = exports.safePromiseThen = void 0;
const SAFE_THENED_WM = new WeakMap();
/**
 ...
 * @param onrejected
 */
function safePromiseThen(fromPromise, onfulfilled, onrejected) {
    ...
    if (!thened) {
        ...
        const toPromise = fromPromise.then((value) => {
            for (const resolveFun of cbs.resolves) {
                ...
                queueMicrotask(async () => {
                    try {
                        ...
                        console.error("Unhandled promise rejection when running onfulfilled", resolveFun, err);
                    }
                });
            }
            finish();
    ...
    return { thened: thened, toPromise };
}
exports.safePromiseThen = safePromiseThen;
function safePromiseOffThen(promise, onfulfilled, onrejected) {
...
exports.safePromiseOffThen = safePromiseOffThen;
