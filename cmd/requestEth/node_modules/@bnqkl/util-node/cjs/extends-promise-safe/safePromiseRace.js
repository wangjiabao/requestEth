...
exports.safePromiseRace = exports.PromiseRace = void 0;
const safePromiseThen_js_1 = require("./safePromiseThen.js");
...
class PromiseRace {
    ...
    addRacer(promise) {
        ...
        if (!thended) {
            ...
            const { thened, toPromise } = (0, safePromiseThen_js_1.safePromiseThen)(promise, onfulfilled, onrejected);
            if (thened.cbs) {
    ...
    race(outter) {
        ...
        if (!inRank) {
            ...
            this._checkToEndRace();
            /// 如果没有自定义输出，那么启用候选名单
            return (this.quota || (this.quota = new index_js_1.PromiseOut())).promise;
        }
 ...
 */
function safePromiseRace(maybePromises) {
    const res = new index_js_1.PromiseOut();
    /**
...
exports.safePromiseRace = safePromiseRace;
