...
function _safeDeepMix(objList) {
    ...
    return new Proxy(objList[0], {
        get(t, prop, r) {
            ...
            const mergeableMatchedValueList = matchedValueList.filter((value) => (0, helper_js_1.mergeAble)(value));
        ...
        getOwnPropertyDescriptor(t, prop) {
            ...
            const mergeableMatchedObjValueList = matchedObjValueList.filter((ov) => (0, helper_js_1.mergeAble)(ov.value));
...
function deepMix(...unsafeObjList) {
    const objList = unsafeObjList.filter(helper_js_1.mergeAble);
    if (objList.length === 0) {
        return {};
    }
