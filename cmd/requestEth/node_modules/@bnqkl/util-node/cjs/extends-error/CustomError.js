...
exports.CustomError = exports.GetCallerInfo = exports.captureErrorStackTrace = void 0;
/**
 * 从堆栈中一个函数的获取调用者的信息
 * @param caller 如果支持`Error.captureStackTrace`，则使用caller定位
 * @param deep 否则直接使用手动计数定位
 */
exports.captureErrorStackTrace = Error.captureStackTrace
    ? (target, caller) => {
...
exports.GetCallerInfo = Error.captureStackTrace
    ? (caller) => {
...
class CustomError extends Error {
    ...
    static call(_this, message) {
        ...
        _this.stack = (0, exports.GetCallerInfo)(_this.constructor);
