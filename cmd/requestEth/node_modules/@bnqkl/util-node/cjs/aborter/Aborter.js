...
class Aborter {
    ...
    wrapAsync(task, label, stackIndex = 0) {
        ...
        if (typeof stackIndex === "number") {
            ...
            const aborter = new index_js_1.PromiseOut();
            stackIndex = {
                aborter,
        ...
        // 等待race返回
        return (0, index_js_2.safePromiseRace)([waitTask, stackIndex.aborter.promise]);
    }
    ...
    get _afterAborted() {
        const po = this._afterAborted_po || (this._afterAborted_po = new index_js_1.PromiseOut());
        if (this._isAborted) {
    ...
    get _abortedPromise() {
        const po = this._abortedPromise_po || (this._abortedPromise_po = new index_js_1.PromiseOut());
        if (this._isAborted) {
