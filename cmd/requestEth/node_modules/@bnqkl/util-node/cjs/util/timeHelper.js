...
exports.TimeHelper = exports.TIME_HELPER_ARGS = void 0;
const tslib_1 = require("tslib");
const index_js_1 = require("../dep_inject/index.js");
const index_js_2 = require("../exception/index.js");
const index_js_3 = require("../extends-promise/index.js");
const platformHelper_js_1 = require("./platformHelper.js");
const { info } = (0, index_js_2.UtilExceptionGenerator)("util", "TimeHelper");
exports.TIME_HELPER_ARGS = {
...
let TimeHelper = TimeHelper_1 = class TimeHelper {
    ...
    sleep(ms, onresolve) {
        return (0, index_js_3.sleep)(ms / this.TIME_SPEED, onresolve);
    }
...
TimeHelper = TimeHelper_1 = tslib_1.__decorate([
    (0, index_js_1.Injectable)(),
    tslib_1.__param(1, (0, index_js_1.Inject)(exports.TIME_HELPER_ARGS.TIME_SPEED, { optional: true })),
    tslib_1.__metadata("design:paramtypes", [platformHelper_js_1.PlatformHelper, Object])
], TimeHelper);
