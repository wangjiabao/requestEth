...
exports.AsyncIteratorGeneratorTransfer = exports.AsyncIteratorGenerator = void 0;
...
/**异步迭代器生成器，@WZX 可能会用到 */
class AsyncIteratorGenerator extends index_js_2.QueneEventEmitter {
    constructor() {
        super(...arguments);
    ...
    _initTask() {
        let task = this._task;
        if (!task) {
            task = this._task = new index_js_3.PromiseOut();
    ...
    [Symbol.asyncIterator]() {
        ...
        return {
            index: 0,
            return() {
                (0, index_js_4.$ignoreAwait)(self.done());
                return Promise.resolve({ done: true, value: undefined });
            },
            async next() {
                const need_index = this.index;
                if (calcs[need_index]) {
                    (0, index_js_4.$ignoreAwait)(calcs[need_index]());
                }
...
exports.AsyncIteratorGenerator = AsyncIteratorGenerator;
 ...
 * @param destAg
 */
const AsyncIteratorGeneratorTransfer = (sourceAg, destAg, filterMap) => {
    let reqNextPoList = [new index_js_3.PromiseOut()];
    const getPoAtList = (poList, index) => {
        let po = poList[index];
        if (po === undefined) {
            po = poList[index] = new index_js_3.PromiseOut();
        }
        return po;
    };
...
exports.AsyncIteratorGeneratorTransfer = AsyncIteratorGeneratorTransfer;
