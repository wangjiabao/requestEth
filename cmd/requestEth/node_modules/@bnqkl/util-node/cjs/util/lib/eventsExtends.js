...
exports.EventTargetCleanerIsolation = exports.EventCleanerIsolation = exports.EventMapIsolation = exports.EventsMap = void 0;
const tslib_1 = require("tslib");
const index_js_1 = require("../../decorator/index.js");
const index_js_2 = require("../../extends-map/index.js");
class EventsMap extends index_js_2.EasyMap {
    constructor(entries) {
...
function EventMapIsolation(eventEmitter) {
...
exports.EventMapIsolation = EventMapIsolation;
/**
 * 事件绑定隔离器
 * 在使用事件清除的时候（`off`,`clear`），能之清理有经过隔离器来进行绑定的事件
 */
class EventCleanerIsolation {
...
exports.EventCleanerIsolation = EventCleanerIsolation;
/**
 * 事件隔离绑定器
 * 针对`EventTarget`类型
 */
class EventTargetCleanerIsolation {
...
exports.EventTargetCleanerIsolation = EventTargetCleanerIsolation;
