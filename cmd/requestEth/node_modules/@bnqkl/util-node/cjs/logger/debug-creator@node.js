 ...
 */
class NodejsDebugCreater extends common_js_1.DebugCreater {
    constructor() {
        super(...arguments);
        /**
    ...
    printArgs(debug, args, scope = debug) {
        switch (scope.level) {
            case common_js_1.LOGGER_LEVEL.log:
                console.log(this.utilFormat(...args));
                break;
            case common_js_1.LOGGER_LEVEL.info:
                console.info(this.utilFormat(...args));
                break;
            case common_js_1.LOGGER_LEVEL.warn:
                console.warn(this.utilFormat(...args));
                break;
            case common_js_1.LOGGER_LEVEL.trace:
                console.trace(this.utilFormat(...args));
                break;
            case common_js_1.LOGGER_LEVEL.success:
                console.info(this.utilFormat(...args));
                break;
            case common_js_1.LOGGER_LEVEL.error:
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:paramtypes", [common_js_1.Debug, Array, Object]),
...
exports.default = DebugCreaterFactory;
