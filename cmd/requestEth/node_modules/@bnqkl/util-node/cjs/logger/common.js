...
exports.LOGGER_LEVEL = exports.Debug = exports.DebugCreater = exports.transformFilterToNamespace = exports.transformNamespaceToFilter = exports.regexpToNamespace = void 0;
const tslib_1 = require("tslib");
/**
 * This is the common logic for both the Node.js and web browser
 * implementations of `debug()`.
 */
const index_js_1 = require("../ms/index.js");
const index_js_2 = require("../decorator/index.js");
const index_js_3 = require("../extends-map/index.js");
/**
...
exports.regexpToNamespace = regexpToNamespace;
function transformNamespaceToFilter(namespace) {
...
exports.transformNamespaceToFilter = transformNamespaceToFilter;
function transformFilterToNamespace(filter) {
    return ((filter.type === "disable" ? "-" : "") + regexpToNamespace(filter.regexp));
}
exports.transformFilterToNamespace = transformFilterToNamespace;
/**
 * 这个类只会执行一次
...
class DebugCreater {
    constructor() {
        ...
        Object.defineProperty(this, "_createdDebugCache", {
            ...
            configurable: true,
            writable: true,
            value: new index_js_3.EasyMap((namespace) => new Debug(namespace, this))
        });
...
exports.DebugCreater = DebugCreater;
class Debug {
    constructor(namespace, _creater, opts) {
        ...
        Object.defineProperty(this, "_scope", {
            ...
            configurable: true,
            writable: true,
            value: new index_js_3.EasyMap((color) => {
                const map = index_js_3.EasyMap.from({
                    creater: (level) => {
                        return {
                            id: this._scopeIdAcc++,
                            color,
    ...
    getDuration() {
        return (0, index_js_1.ms)(this.getDiff());
    }
    get _dater() {
        return new Date();
    }
