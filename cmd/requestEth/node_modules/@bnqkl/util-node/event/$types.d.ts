...
import { $EventInOutMap, $InnerAnyInOutHandlerArg, $InOutEventHandler, $InOutSyncEventHandler } from "../event-quene_emitter/$types.js";
import { $PromiseOut } from "../extends-promise-out/$types.js";
import { QueneEventEmitter } from "./index.js";
export declare type $EventWaitterMap<EM> = {
...
export interface $QueneEventEmitterPro<EM extends $EventInOutMap = {}> extends QueneEventEmitter<EM> {
    onEmit(commonHanlder: $MutArgEventHandler<$InnerAnyInOutHandlerArg<EM>>, opts?: $EventOptions): void;
...
export interface SyncQueneEventEmitterPro<EM extends $EventInOutMap = {}> extends $QueneEventEmitterPro<EM> {
    on<K extends keyof EM>(eventname: K, handler: $InOutSyncEventHandler<EM[K]>, opts?: $EventOptions): void;
    has<K extends keyof EM>(eventname: K, handler?: $InOutSyncEventHandler<EM[K]>): boolean;
    off<K extends keyof EM>(eventname: K, handler: $InOutSyncEventHandler<EM[K]>): boolean;
    emit<K extends keyof EM>(eventname: K, data: EM[K]["in"]): EM[K]["out"] | undefined;
