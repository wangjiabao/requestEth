import { $ErrorCode } from "../exception-error-code/$types.js";
import { ExceptionGenerator, EXCEPTION_SEVERIFY } from "./ExceptionGenerator.js";
export interface $ExceptionCollection extends ReturnType<typeof ExceptionGenerator> {
}
export declare type $EXCEPTION_SEVERIFY = typeof EXCEPTION_SEVERIFY;
export interface $ExceptionConstructor<E extends $Exception = $Exception> {
    new (message?: string | $ErrorCode, detail?: any, CODE?: string, SEVERIFY?: EXCEPTION_SEVERIFY): E;
