...
export declare type $Binary = $Buffer | $TypedArray | DataView;
export declare type $BinaryLike = string | $Binary;
export declare type $Utf8AsciiLatin1Encoding = "utf8" | "ascii" | "latin1";
export declare type $HexBase64Latin1Encoding = "latin1" | "hex" | "base64";
export declare type $BufferEncoding = "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "base64" | "latin1" | "binary" | "hex";
...
export interface $BufferConstructor {
     ...
     */
    byteLength(string: string | $TypedArray | DataView | ArrayBuffer | SharedArrayBuffer, encoding?: $BufferEncoding): number;
    /**
