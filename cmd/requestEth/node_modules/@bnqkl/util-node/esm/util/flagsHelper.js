...
import { ModuleStroge, Resolve, Injectable } from "../dep_inject/index.js";
...
FlagParamStack = __decorate([
    Injectable()
], FlagParamStack);
export { FlagParamStack };
    ...
    registerInjectionFlag(flag, ModuleFactory, type = "boolean") {
        ...
        this._flagInfomationMap.set(flag, {
            ...
            onEnable: (v) => {
                ...
                const ins = Resolve(ModuleFactory, moduleMap.installMask(new ModuleStroge([[FLAG_INJECTION_PARAM, v]])));
                this.flagParamStack.setParam(ins, v);
            },
        });
    }
};
FlagsHelper = __decorate([
    Injectable(),
