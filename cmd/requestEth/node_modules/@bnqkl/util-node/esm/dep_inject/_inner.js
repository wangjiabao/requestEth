 ...
 * 对象与其ModelStroge的映射
 */
export const INSTANCE_MODULES_WM = new WeakMap();
/**
 ...
 */
export const beforeCreateInstanceModuleStrogeStack = [];
export function getInstanceModules(ins) {
    return (INSTANCE_MODULES_WM.get(ins) ||
