...
exports.blake2b_final = exports.blake2b_update = exports.blake2b_init = exports.blake2b = void 0;
...
function blake2b_init(outlen, key) {
    ...
    // hash state
    const h = new array_1.WordArray(16);
...
exports.blake2b_init = blake2b_init;
...
exports.blake2b_update = blake2b_update;
...
function blake2b_final(ctx) {
    ...
    const out = new array_1.ByteArray(ctx.outlen);
    for (let i = 0; i < ctx.outlen; i++) {
        out[i] = ctx.h[i >> 2] >> (8 * (i & 3));
    }
    return out;
}
exports.blake2b_final = blake2b_final;
// Initialization Vector
const BLAKE2B_IV32 = new array_1.WordArray([
...
const SIGMA82 = new array_1.ByteArray(SIGMA8.map((x) => x * 2));
// Compression function. 'last' flag indicates last block.
// Note we're representing 16 uint64s as 32 uint32s
const v = new array_1.WordArray(32);
const m = new array_1.WordArray(32);
