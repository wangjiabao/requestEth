...
exports._hash = exports.hash = void 0;
const array_1 = require("./array");
const check_1 = require("./check");
function hash(msg) {
    (0, check_1.checkArrayTypes)(msg);
    const h = new array_1.ByteArray(64 /* HashLength.Hash */);
    _hash(h, msg, msg.length);
    return h;
}
exports.hash = hash;
function _hash(out, m, n) {
    const hh = new array_1.IntArray(8), hl = new array_1.IntArray(8), x = new array_1.ByteArray(256);
    let i, b = n;
    hh[0] = 0x6a09e667;
    hh[1] = 0xbb67ae85;
    hh[2] = 0x3c6ef372;
...
function _hashblocks_hl(hh, hl, m, n) {
    const wh = new array_1.IntArray(16), wl = new array_1.IntArray(16);
    // prettier-ignore
