...
exports.parseHexToArrayBuffer = exports.encodeHexToBinary = exports.getHexFromArrayBuffer = exports.decodeBinaryToHex = exports.decodeHex = exports.encodeHex = void 0;
const HEX_DECODE_CACHE = new WeakMap();
const EMPTY_UINT8_ARRAY = new Uint8Array();
const BINARY_HEX_CACHE = [];
const HEX_BINARY_CACHE = Object.create({});
...
/**解码ArrayBuffer成hex字符串 */
function decodeBinaryToHex(binary) {
    if (!binary) {
        return "";
    }
    let res;
...
exports.decodeBinaryToHex = decodeBinaryToHex;
/**解码ArrayBuffer成hex字符串 */
exports.getHexFromArrayBuffer = decodeBinaryToHex;
/**编码hex字符串写成ArrayBuffer */
function encodeHexToBinary(value) {
    if (!value) {
...
exports.encodeHexToBinary = encodeHexToBinary;
/**编码hex字符串写成ArrayBuffer */
exports.parseHexToArrayBuffer = encodeHexToBinary;
//# sourceMappingURL=hexConvert.js.map