...
exports._stream_xor = exports._stream = exports._sigma = exports._hsalsa20 = exports._salsa20 = void 0;
...
exports._hsalsa20 = _hsalsa20;
exports._sigma = new array_1.ByteArray([
    101, 120, 112, 97, 110, 100, 32, 51, 50, 45, 98, 121, 116, 101, 32, 107,
]);
// "expand 32-byte k"
function _stream_salsa20_xor(c, cpos, m, mpos, b, n, k) {
    const z = new array_1.ByteArray(16), x = new array_1.ByteArray(64);
    let u, i;
    for (i = 0; i < 16; i++)
        z[i] = 0;
    for (i = 0; i < 8; i++)
...
function _stream(c, cpos, d, n, k) {
    const s = new array_1.ByteArray(32), sn = new array_1.ByteArray(8);
    _hsalsa20(s, n, k, exports._sigma);
    for (let i = 0; i < 8; i++)
        sn[i] = n[i + 16];
...
exports._stream_xor = _stream_xor;
