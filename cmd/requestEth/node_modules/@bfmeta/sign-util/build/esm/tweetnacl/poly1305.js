...
exports.poly1305_update = exports.poly1305_finish = exports.poly1305_blocks = exports.poly1305_init = void 0;
const array_1 = require("./array");
function poly1305_init(key) {
    const r = new array_1.HalfArray(10);
    const pad = new array_1.HalfArray(8);
    ...
    return {
        buffer: new array_1.ByteArray(16),
        r,
        h: new array_1.HalfArray(10),
        pad,
        leftover: 0,
        fin: 0,
    };
...
function poly1305_finish(self, mac, macpos) {
    const g = new array_1.ByteArray(10);
    let c, mask, f, i;
