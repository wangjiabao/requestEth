...
(async () => {
    try {
        ...
        const argv = {
            ...
            fee: "10000",
            applyBlockHeight: 10,
            remark: { message: "create destroyCertificate" },
            recipientId: "cLrUCNAWPyPH96bqqC3JQXZ3CtsvvXmNj1",
            certificateId: (0, helpers_1.getRandomCertificateId)(12),
            type: 1,
        };
        const sdk = helpers_1.bfmetaSDK;
        const createResult = await sdk.api.transaction.createDestroyCertificate(argv);
        if (createResult.success) {
            ...
            const broadcastResult = await sdk.api.transaction.broadcastDestroyCertificate({
                buffer,
                signature,
            });
