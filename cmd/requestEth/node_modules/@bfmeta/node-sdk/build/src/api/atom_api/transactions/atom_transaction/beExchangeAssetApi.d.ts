...
export declare class BeExchangeAssetApi extends TransactionApi {
    ...
    createTransaction(argv: BFMetaNodeSDK.Transaction.BeExchangeAssetTransactionParams): Promise<BFMetaNodeSDK.ApiFailureReturn | BFMetaNodeSDK.Transaction.CreateResult>;
}
