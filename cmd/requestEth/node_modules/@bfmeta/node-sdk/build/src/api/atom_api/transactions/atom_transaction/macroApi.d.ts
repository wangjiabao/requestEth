...
export declare class MacroApi extends TransactionApi {
    ...
    createTransaction(argv: BFMetaNodeSDK.Transaction.MacroTransactionParams): Promise<BFMetaNodeSDK.ApiFailureReturn | BFMetaNodeSDK.Transaction.CreateResult>;
}
