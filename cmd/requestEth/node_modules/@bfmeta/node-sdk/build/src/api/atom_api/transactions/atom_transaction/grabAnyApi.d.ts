...
export declare class GrabAnyApi extends TransactionApi {
    ...
    createTransaction(argv: BFMetaNodeSDK.Transaction.GrabAnyTransactionParams): Promise<BFMetaNodeSDK.ApiFailureReturn | BFMetaNodeSDK.Transaction.CreateResult>;
}
