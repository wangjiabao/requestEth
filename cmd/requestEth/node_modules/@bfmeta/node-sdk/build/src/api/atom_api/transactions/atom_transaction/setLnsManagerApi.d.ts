...
export declare class SetLnsManagerApi extends TransactionApi {
    ...
    createTransaction(argv: BFMetaNodeSDK.Transaction.SetLnsManagerTransactionParams): Promise<BFMetaNodeSDK.ApiFailureReturn | BFMetaNodeSDK.Transaction.CreateResult>;
}
