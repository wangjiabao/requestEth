...
export declare class IssueEntityMultiApi extends TransactionApi {
    ...
    createTransaction(argv: BFMetaNodeSDK.Transaction.IssueEntityMultiTransactionParams): Promise<BFMetaNodeSDK.ApiFailureReturn | BFMetaNodeSDK.Transaction.CreateResult>;
}
