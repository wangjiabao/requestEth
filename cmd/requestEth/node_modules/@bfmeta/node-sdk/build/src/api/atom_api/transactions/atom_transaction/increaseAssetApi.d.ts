...
export declare class IncreaseAssetApi extends TransactionApi {
    ...
    createTransaction(argv: BFMetaNodeSDK.Transaction.IncreaseAssetTransactionParams): Promise<BFMetaNodeSDK.ApiFailureReturn | BFMetaNodeSDK.Transaction.CreateResult>;
}
