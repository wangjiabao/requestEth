...
export declare class ToExchangeAssetApi extends TransactionApi {
    ...
    createTransaction(argv: BFMetaNodeSDK.Transaction.ToExchangeAssetTransactionParams): Promise<BFMetaNodeSDK.ApiFailureReturn | BFMetaNodeSDK.Transaction.CreateResult>;
}
