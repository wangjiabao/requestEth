...
export declare class IssueEntityFactoryV1Api extends TransactionApi {
    ...
    createTransaction(argv: BFMetaNodeSDK.Transaction.IssueEntityFactoryTransactionV1Params): Promise<BFMetaNodeSDK.ApiFailureReturn | BFMetaNodeSDK.Transaction.CreateResult>;
}
