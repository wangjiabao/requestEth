...
export declare class StakeAssetApi extends TransactionApi {
    ...
    createTransaction(argv: BFMetaNodeSDK.Transaction.StakeAssetTransactionParams): Promise<BFMetaNodeSDK.ApiFailureReturn | BFMetaNodeSDK.Transaction.CreateResult>;
}
