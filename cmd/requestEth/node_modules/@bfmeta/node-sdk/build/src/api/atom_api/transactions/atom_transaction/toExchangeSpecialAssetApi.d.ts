...
export declare class ToExchangeSpecialAssetApi extends TransactionApi {
    ...
    createTransaction(argv: BFMetaNodeSDK.Transaction.ToExchangeSpecialAssetTransactionParams): Promise<BFMetaNodeSDK.ApiFailureReturn | BFMetaNodeSDK.Transaction.CreateResult>;
}
