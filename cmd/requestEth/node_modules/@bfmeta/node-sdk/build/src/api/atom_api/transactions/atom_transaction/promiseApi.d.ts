...
export declare class PromiseApi extends TransactionApi {
    ...
    createTransaction(argv: BFMetaNodeSDK.Transaction.PromiseTransactionParams): Promise<BFMetaNodeSDK.ApiFailureReturn | BFMetaNodeSDK.Transaction.CreateResult>;
}
