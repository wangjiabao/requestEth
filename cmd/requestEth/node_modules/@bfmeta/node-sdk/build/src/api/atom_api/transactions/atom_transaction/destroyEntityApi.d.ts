...
export declare class DestroyEntityApi extends TransactionApi {
    ...
    createTransaction(argv: BFMetaNodeSDK.Transaction.DestroyEntityTransactionParams): Promise<BFMetaNodeSDK.ApiFailureReturn | BFMetaNodeSDK.Transaction.CreateResult>;
}
