...
export declare class DestroyCertificateApi extends TransactionApi {
    ...
    createTransaction(argv: BFMetaNodeSDK.Transaction.DestroyCertificateTransactionParams): Promise<BFMetaNodeSDK.ApiFailureReturn | BFMetaNodeSDK.Transaction.CreateResult>;
}
