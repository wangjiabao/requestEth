...
export declare class ToExchangeAnyMultiAllApi extends TransactionApi {
    ...
    createTransaction(argv: BFMetaNodeSDK.Transaction.ToExchangeAnyMultiAllTransactionParams): Promise<BFMetaNodeSDK.ApiFailureReturn | BFMetaNodeSDK.Transaction.CreateResult>;
}
