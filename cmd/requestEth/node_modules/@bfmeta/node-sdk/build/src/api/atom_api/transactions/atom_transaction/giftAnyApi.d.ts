...
export declare class GiftAnyApi extends TransactionApi {
    ...
    createTransaction(argv: BFMetaNodeSDK.Transaction.GiftAnyTransactionParams): Promise<BFMetaNodeSDK.ApiFailureReturn | BFMetaNodeSDK.Transaction.CreateResult>;
}
