...
export declare class ToExchangeAnyApi extends TransactionApi {
    ...
    createTransaction(argv: BFMetaNodeSDK.Transaction.ToExchangeAnyTransactionParams): Promise<BFMetaNodeSDK.ApiFailureReturn | BFMetaNodeSDK.Transaction.CreateResult>;
}
