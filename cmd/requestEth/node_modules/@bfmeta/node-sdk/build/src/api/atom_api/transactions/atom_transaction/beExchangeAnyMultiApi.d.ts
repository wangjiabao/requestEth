...
export declare class BeExchangeAnyMultiApi extends TransactionApi {
    ...
    createTransaction(argv: BFMetaNodeSDK.Transaction.BeExchangeAnyMultiTransactionParams): Promise<BFMetaNodeSDK.ApiFailureReturn | BFMetaNodeSDK.Transaction.CreateResult>;
}
