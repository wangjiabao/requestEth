...
var FactoryMetaData = &bind.MetaData{
	ABI: "[{\"inputs\":[{\"internalType\":\"address\",\"name\":\"implementation_\",\"type\":\"address\"},{\"internalType\":\"address\",\"name\":\"nft_\",\"type\":\"address\"},{\"internalType\":\"address\",\"name\":\"usdt_\",\"type\":\"address\"}],\"stateMutability\":\"nonpayable\",\"type\":\"constructor\"},{\"inputs\":[],\"name\":\"AccessControlBadConfirmation\",\"type\":\"error\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"account\",\"type\":\"address\"},{\"internalType\":\"bytes32\",\"name\":\"neededRole\",\"type\":\"bytes32\"}],\"name\":\"AccessControlUnauthorizedAccount\",\"type\":\"error\"},{\"inputs\":[],\"name\":\"FailedDeployment\",\"type\":\"error\"},{\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"balance\",\"type\":\"uint256\"},{\"internalType\":\"uint256\",\"name\":\"needed\",\"type\":\"uint256\"}],\"name\":\"InsufficientBalance\",\"type\":\"error\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"bytes32\",\"name\":\"role\",\"type\":\"bytes32\"},{\"indexed\":true,\"internalType\":\"bytes32\",\"name\":\"previousAdminRole\",\"type\":\"bytes32\"},{\"indexed\":true,\"internalType\":\"bytes32\",\"name\":\"newAdminRole\",\"type\":\"bytes32\"}],\"name\":\"RoleAdminChanged\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"bytes32\",\"name\":\"role\",\"type\":\"bytes32\"},{\"indexed\":true,\"internalType\":\"address\",\"name\":\"account\",\"type\":\"address\"},{\"indexed\":true,\"internalType\":\"address\",\"name\":\"sender\",\"type\":\"address\"}],\"name\":\"RoleGranted\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"bytes32\",\"name\":\"role\",\"type\":\"bytes32\"},{\"indexed\":true,\"internalType\":\"address\",\"name\":\"account\",\"type\":\"address\"},{\"indexed\":true,\"internalType\":\"address\",\"name\":\"sender\",\"type\":\"address\"}],\"name\":\"RoleRevoked\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"address\",\"name\":\"user\",\"type\":\"address\"},{\"indexed\":true,\"internalType\":\"address\",\"name\":\"vault\",\"type\":\"address\"}],\"name\":\"VaultCreated\",\"type\":\"event\"},{\"inputs\":[],\"name\":\"ADMIN_ROLE\",\"outputs\":[{\"internalType\":\"bytes32\",\"name\":\"\",\"type\":\"bytes32\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"DEFAULT_ADMIN_ROLE\",\"outputs\":[{\"internalType\":\"bytes32\",\"name\":\"\",\"type\":\"bytes32\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"createVault\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"vault\",\"type\":\"address\"}],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"user\",\"type\":\"address\"}],\"name\":\"createVaultFor\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"vault\",\"type\":\"address\"}],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"bytes32\",\"name\":\"role\",\"type\":\"bytes32\"}],\"name\":\"getRoleAdmin\",\"outputs\":[{\"internalType\":\"bytes32\",\"name\":\"\",\"type\":\"bytes32\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"bytes32\",\"name\":\"role\",\"type\":\"bytes32\"},{\"internalType\":\"address\",\"name\":\"account\",\"type\":\"address\"}],\"name\":\"grantRole\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"bytes32\",\"name\":\"role\",\"type\":\"bytes32\"},{\"internalType\":\"address\",\"name\":\"account\",\"type\":\"address\"}],\"name\":\"hasRole\",\"outputs\":[{\"internalType\":\"bool\",\"name\":\"\",\"type\":\"bool\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"implementation\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"nft\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"bytes32\",\"name\":\"role\",\"type\":\"bytes32\"},{\"internalType\":\"address\",\"name\":\"callerConfirmation\",\"type\":\"address\"}],\"name\":\"renounceRole\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"bytes32\",\"name\":\"role\",\"type\":\"bytes32\"},{\"internalType\":\"address\",\"name\":\"account\",\"type\":\"address\"}],\"name\":\"revokeRole\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"bytes4\",\"name\":\"interfaceId\",\"type\":\"bytes4\"}],\"name\":\"supportsInterface\",\"outputs\":[{\"internalType\":\"bool\",\"name\":\"\",\"type\":\"bool\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"usdt\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"name\":\"vaultOf\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"stateMutability\":\"view\",\"type\":\"function\"}]",
}
...
func (_Factory *FactoryCaller) ADMINROLE(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _Factory.contract.Call(opts, &out, "ADMIN_ROLE")
...
//
// Solidity: function ADMIN_ROLE() view returns(bytes32)
func (_Factory *FactorySession) ADMINROLE() ([32]byte, error) {
	return _Factory.Contract.ADMINROLE(&_Factory.CallOpts)
}

// ADMINROLE is a free data retrieval call binding the contract method 0x75b238fc.
//
// Solidity: function ADMIN_ROLE() view returns(bytes32)
func (_Factory *FactoryCallerSession) ADMINROLE() ([32]byte, error) {
	return _Factory.Contract.ADMINROLE(&_Factory.CallOpts)
}
...
func (_Factory *FactoryCaller) Nft(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Factory.contract.Call(opts, &out, "nft")
...
//
// Solidity: function nft() view returns(address)
func (_Factory *FactorySession) Nft() (common.Address, error) {
	return _Factory.Contract.Nft(&_Factory.CallOpts)
}

// Nft is a free data retrieval call binding the contract method 0x47ccca02.
//
// Solidity: function nft() view returns(address)
func (_Factory *FactoryCallerSession) Nft() (common.Address, error) {
	return _Factory.Contract.Nft(&_Factory.CallOpts)
}
...
func (_Factory *FactoryCaller) Usdt(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Factory.contract.Call(opts, &out, "usdt")
...
//
// Solidity: function usdt() view returns(address)
func (_Factory *FactorySession) Usdt() (common.Address, error) {
	return _Factory.Contract.Usdt(&_Factory.CallOpts)
}

// Usdt is a free data retrieval call binding the contract method 0x2f48ab7d.
//
// Solidity: function usdt() view returns(address)
func (_Factory *FactoryCallerSession) Usdt() (common.Address, error) {
	return _Factory.Contract.Usdt(&_Factory.CallOpts)
}

// VaultOf is a free data retrieval call binding the contract method 0x0709df45.
//
// Solidity: function vaultOf(address ) view returns(address)
func (_Factory *FactoryCaller) VaultOf(opts *bind.CallOpts, arg0 common.Address) (common.Address, error) {
	var out []interface{}
	err := _Factory.contract.Call(opts, &out, "vaultOf", arg0)
...
//
// Solidity: function vaultOf(address ) view returns(address)
func (_Factory *FactorySession) VaultOf(arg0 common.Address) (common.Address, error) {
	return _Factory.Contract.VaultOf(&_Factory.CallOpts, arg0)
}

// VaultOf is a free data retrieval call binding the contract method 0x0709df45.
//
// Solidity: function vaultOf(address ) view returns(address)
func (_Factory *FactoryCallerSession) VaultOf(arg0 common.Address) (common.Address, error) {
	return _Factory.Contract.VaultOf(&_Factory.CallOpts, arg0)
}

// CreateVault is a paid mutator transaction binding the contract method 0x5d12928b.
//
// Solidity: function createVault() returns(address vault)
...
// CreateVaultFor is a paid mutator transaction binding the contract method 0x1a966d70.
//
// Solidity: function createVaultFor(address user) returns(address vault)
func (_Factory *FactoryTransactor) CreateVaultFor(opts *bind.TransactOpts, user common.Address) (*types.Transaction, error) {
	return _Factory.contract.Transact(opts, "createVaultFor", user)
}

// CreateVaultFor is a paid mutator transaction binding the contract method 0x1a966d70.
//
// Solidity: function createVaultFor(address user) returns(address vault)
func (_Factory *FactorySession) CreateVaultFor(user common.Address) (*types.Transaction, error) {
	return _Factory.Contract.CreateVaultFor(&_Factory.TransactOpts, user)
}

// CreateVaultFor is a paid mutator transaction binding the contract method 0x1a966d70.
//
// Solidity: function createVaultFor(address user) returns(address vault)
func (_Factory *FactoryTransactorSession) CreateVaultFor(user common.Address) (*types.Transaction, error) {
	return _Factory.Contract.CreateVaultFor(&_Factory.TransactOpts, user)
}
...
func (_Factory *FactoryTransactor) RenounceRole(opts *bind.TransactOpts, role [32]byte, callerConfirmation common.Address) (*types.Transaction, error) {
	return _Factory.contract.Transact(opts, "renounceRole", role, callerConfirmation)
}

// RenounceRole is a paid mutator transaction binding the contract method 0x36568abe.
//
// Solidity: function renounceRole(bytes32 role, address callerConfirmation) returns()
func (_Factory *FactorySession) RenounceRole(role [32]byte, callerConfirmation common.Address) (*types.Transaction, error) {
	return _Factory.Contract.RenounceRole(&_Factory.TransactOpts, role, callerConfirmation)
}

// RenounceRole is a paid mutator transaction binding the contract method 0x36568abe.
//
// Solidity: function renounceRole(bytes32 role, address callerConfirmation) returns()
func (_Factory *FactoryTransactorSession) RenounceRole(role [32]byte, callerConfirmation common.Address) (*types.Transaction, error) {
	return _Factory.Contract.RenounceRole(&_Factory.TransactOpts, role, callerConfirmation)
}
...
// FactoryVaultCreatedIterator is returned from FilterVaultCreated and is used to iterate over the raw logs and unpacked data for VaultCreated events raised by the Factory contract.
type FactoryVaultCreatedIterator struct {
	Event *FactoryVaultCreated // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *FactoryVaultCreatedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(FactoryVaultCreated)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *FactoryVaultCreatedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *FactoryVaultCreatedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// FactoryVaultCreated represents a VaultCreated event raised by the Factory contract.
type FactoryVaultCreated struct {
	User  common.Address
...
//
// Solidity: event VaultCreated(address indexed user, address indexed vault)
func (_Factory *FactoryFilterer) FilterVaultCreated(opts *bind.FilterOpts, user []common.Address, vault []common.Address) (*FactoryVaultCreatedIterator, error) {
	...
	logs, sub, err := _Factory.contract.FilterLogs(opts, "VaultCreated", userRule, vaultRule)
	if err != nil {
		return nil, err
	}
	return &FactoryVaultCreatedIterator{contract: _Factory.contract, event: "VaultCreated", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event VaultCreated(address indexed user, address indexed vault)
func (_Factory *FactoryFilterer) WatchVaultCreated(opts *bind.WatchOpts, sink chan<- *FactoryVaultCreated, user []common.Address, vault []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Factory.contract.WatchLogs(opts, "VaultCreated", userRule, vaultRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(FactoryVaultCreated)
				if err := _Factory.contract.UnpackLog(event, "VaultCreated", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event VaultCreated(address indexed user, address indexed vault)
func (_Factory *FactoryFilterer) ParseVaultCreated(log types.Log) (*FactoryVaultCreated, error) {
	event := new(FactoryVaultCreated)
	if err := _Factory.contract.UnpackLog(event, "VaultCreated", log); err != nil {
		return nil, err
	}
